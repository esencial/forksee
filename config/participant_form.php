...
$participantform[]=array(
'mysql_column_name'=>'identification_number',
'name_lang'=>'identification_number',
'type'=>'textline',
'subpools'=>'all',
'compulsory'=>'n',
//'error_message_if_empty_lang'=>'you_have_to_identification_number',
'default_value'=>'',
'size'=>'20',
'maxlength'=>'50',
'search_include_in_participant_query'=>'y',
...
//[SST] nuevo campo del formulario (Nombre identificativo)
$participantform[]=array(
'mysql_column_name'=>'identification_name',
'name_lang'=>'identification_name',
'type'=>'textline',
'subpools'=>'all',
'compulsory'=>'y',
'error_message_if_empty_lang'=>'you_have_to_identification_name',
'require_unique_on_create_page'=>'y',
'unique_on_create_page_error_message_if_exists_lang'=>'you_have_to_identification_name_exists',
'unique_on_create_page_tell_if_deleted'=>'n',
'unique_on_create_page_email_regmail_confmail_again'=>'y',
'check_unique_on_edit_page'=>'y',
'unique_on_edit_page_error_message_if_exists_lang'=>'you_have_to_identification_name_exists',
'default_value'=>'',
'size'=>'20',
'maxlength'=>'50',
'search_include_in_participant_query'=>'y',
...
//[SGC] nuevo campo del formulario (Menor de edad)
$participantform[]=array(
'mysql_column_name'=>'underage',
'name_lang'=>'underage',
'type'=>'radioline',
'subpools'=>'all',
'option_values'=>'1,0',
...
//[SGC] nuevo campo del formulario (nombre del padre)
$participantform[]=array(
'mysql_column_name'=>'parent_fname',
'name_lang'=>'parent_firstname',
'type'=>'textline',
'subpools'=>'all',
'compulsory'=>'n',
'error_message_if_empty_lang'=>'you_have_to_fname',
...
//[SGC] nuevo campo del formulario (apellido del padre)
$participantform[]=array(
'mysql_column_name'=>'parent_lname',
'name_lang'=>'parent_lastname',
'type'=>'textline',
'subpools'=>'all',
'compulsory'=>'n',
'error_message_if_empty_lang'=>'you_have_to_lname',
...
//[SGC] nuevo campo del formulario (DNI padre)
$participantform[]=array(
'mysql_column_name'=>'parent_id',
'name_lang'=>'parent_id',
'type'=>'textline',
'subpools'=>'all',
'compulsory'=>'n',
'error_message_if_empty_lang'=>'you_have_to_identification_number',
'require_unique_on_create_page'=>'y',
'unique_on_create_page_error_message_if_exists_lang'=>'Ya existe este valor',
'unique_on_create_page_tell_if_deleted'=>'y',
'unique_on_create_page_email_regmail_confmail_again'=>'y',
'check_unique_on_edit_page'=>'y',
'unique_on_edit_page_error_message_if_exists_lang'=>'Ya existe este valor',
'default_value'=>'',
'size'=>'20',
'maxlength'=>'50',
'search_include_in_participant_query'=>'y',
...
//[SGC] nuevo campo del formulario (alertas activas)
$participantform[]=array(
...
//[SGC] nuevo campo del formulario (banned)
$participantform[]=array(
'mysql_column_name'=>'banned',
'name_lang'=>'banned',
'type'=>'radioline',
'subpools'=>'all',
'option_values'=>'1,0',
...
//[SGC] nuevo campo del formulario (estudiante de la UGR)
$participantform[]=array(
'mysql_column_name'=>'student_from_this_university',
'name_lang'=>'student_from_this_university',
'type'=>'radioline',
'subpools'=>'all',
'option_values'=>'1,0',
'option_values_lang'=>'yes,no',
...
//[SGC] nuevo campo del formulario (día de nacimiento)
$participantform[]=array(
'mysql_column_name'=>'day_of_birth',
'name_lang'=>'day',
'type'=>'select_numbers',
'subpools'=>'all',
'default_value'=>'',
...
//[SGC] nuevo campo del formulario (mes de nacimiento)
$participantform[]=array(
'mysql_column_name'=>'month_of_birth',
'name_lang'=>'month',
'type'=>'select_numbers',
'subpools'=>'all',
'default_value'=>'',
...
//[SGC] nuevo campo del formulario (año de nacimiento)
$participantform[]=array(
'mysql_column_name'=>'year_of_birth',
'name_lang'=>'year',
'type'=>'select_numbers',
'subpools'=>'all',
'default_value'=>'',
...
//[SGC] nuevo campo del formulario (deficiencias auditivas)
$participantform[]=array(
'mysql_column_name'=>'auditory_impairments',
'name_lang'=>'auditory_impairments',
'type'=>'select_lang',
'subpools'=>'all',
'default_value'=>'',
'include_none_option'=>'n',
...
//[SGC] nuevo campo del formulario (tiene hijos)
$participantform[]=array(
'mysql_column_name'=>'children',
'name_lang'=>'children',
'type'=>'select_lang',
'subpools'=>'all',
'default_value'=>'',
